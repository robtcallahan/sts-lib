...
/*******************************************************************************
 *
 * $Id: CMDBSANSwitchTest.php 79018 2013-09-19 00:06:03Z rcallaha $
 * $Date: 2013-09-18 20:06:03 -0400 (Wed, 18 Sep 2013) $
 * $Author: rcallaha $
 * $Revision: 79018 $
 * $HeadURL: https://svn.ultradns.net/svn/sts_tools/sts-lib/trunk/test/CMDB/CMDBSANSwitchTest.php $
 *
 *******************************************************************************
 */

class CMDBSANSwitchTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var STS\CMDB\CMDBSANSwitch
     */
    protected $object;

    /**
     * @var STS\CMDB\CMDBSANSwitchTable
     */
    ...
    {
        $this->object = new \STS\CMDB\CMDBSANSwitch();
        $this->objectTable = new StubCMDBSANSwitchTable();
    }
    ...
    /**
     * @covers \STS\CMDB\CMDBSANSwitch::getChanges
     * @covers \STS\CMDB\CMDBSANSwitch::clearChanges
     */
    ...
    /**
     * @covers \STS\CMDB\CMDBSANSwitch::__toString
     */
    ...
    /**
     * @covers \STS\CMDB\CMDBSANSwitch::toObject
     */
