...
/*******************************************************************************
 *
 * $Id: CMDBUserTest.php 79018 2013-09-19 00:06:03Z rcallaha $
 * $Date: 2013-09-18 20:06:03 -0400 (Wed, 18 Sep 2013) $
 * $Author: rcallaha $
 * $Revision: 79018 $
 * $HeadURL: https://svn.ultradns.net/svn/sts_tools/sts-lib/trunk/test/CMDB/CMDBUserTest.php $
 *
 *******************************************************************************
 */

class CMDBUserTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var STS\CMDB\CMDBUser
     */
    protected $object;

    /**
     * @var STS\CMDB\CMDBUserTable
     */
    ...
    {
        $this->object = new \STS\CMDB\CMDBUser();
        $this->objectTable = new StubCMDBUserTable();
    }
    ...
    /**
     * @covers \STS\CMDB\CMDBUser::getChanges
     * @covers \STS\CMDB\CMDBUser::clearChanges
     */
    ...
    /**
     * @covers \STS\CMDB\CMDBUser::__toString
     */
    ...
    /**
     * @covers \STS\CMDB\CMDBUser::toObject
     */
