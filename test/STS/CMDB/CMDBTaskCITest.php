...
class CMDBTaskCITest extends PHPUnit_Framework_TestCase
{
    /**
     * @var STS\CMDB\CMDBTaskCI
     */
    protected $object;

    /**
     * @var STS\CMDB\CMDBTaskCITable
     */
    ...
    {
        $this->object = new \STS\CMDB\CMDBTaskCI();
        $this->objectTable = new StubCMDBTaskCITable();
    }
    ...
    /**
     * @covers \STS\CMDB\CMDBTaskCI::getChanges
     * @covers \STS\CMDB\CMDBTaskCI::clearChanges
     */
    ...
    /**
     * @covers \STS\CMDB\CMDBTaskCI::__toString
     */
    ...
    /**
     * @covers \STS\CMDB\CMDBTaskCI::toObject
     */
