...
/*******************************************************************************
 *
 * $Id: CMDBRelationshipTypeTest.php 79018 2013-09-19 00:06:03Z rcallaha $
 * $Date: 2013-09-18 20:06:03 -0400 (Wed, 18 Sep 2013) $
 * $Author: rcallaha $
 * $Revision: 79018 $
 * $HeadURL: https://svn.ultradns.net/svn/sts_tools/sts-lib/trunk/test/CMDB/CMDBRelationshipTypeTest.php $
 *
 *******************************************************************************
 */

class CMDBRelationshipTypeTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var STS\CMDB\CMDBRelationshipType
     */
    protected $object;

    /**
     * @var STS\CMDB\CMDBRelationshipTypeTable
     */
    ...
    {
        $this->object = new \STS\CMDB\CMDBRelationshipType();
        $this->objectTable = new StubCMDBRelationshipTypeTable();
    }
    ...
    /**
     * @covers \STS\CMDB\CMDBRelationshipType::getChanges
     * @covers \STS\CMDB\CMDBRelationshipType::clearChanges
     */
    ...
    /**
     * @covers \STS\CMDB\CMDBRelationshipType::__toString
     */
    ...
    /**
     * @covers \STS\CMDB\CMDBRelationshipType::toObject
     */
