...
class CMDBRequestItemTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var STS\CMDB\CMDBRequestItem
     */
    protected $object;

    /**
     * @var STS\CMDB\CMDBRequestItemTable
     */
    ...
    {
        $this->object = new \STS\CMDB\CMDBRequestItem();
        $this->objectTable = new StubCMDBRequestItemTable();
    }
    ...
    /**
     * @covers \STS\CMDB\CMDBRequestItem::getChanges
     * @covers \STS\CMDB\CMDBRequestItem::clearChanges
     */
    ...
    /**
     * @covers \STS\CMDB\CMDBRequestItem::__toString
     */
    ...
    /**
     * @covers \STS\CMDB\CMDBRequestItem::toObject
     */
