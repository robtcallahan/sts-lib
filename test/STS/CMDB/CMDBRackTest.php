...
/*******************************************************************************
 *
 * $Id: CMDBRackTest.php 79018 2013-09-19 00:06:03Z rcallaha $
 * $Date: 2013-09-18 20:06:03 -0400 (Wed, 18 Sep 2013) $
 * $Author: rcallaha $
 * $Revision: 79018 $
 * $HeadURL: https://svn.ultradns.net/svn/sts_tools/sts-lib/trunk/test/CMDB/CMDBRackTest.php $
 *
 *******************************************************************************
 */

class CMDBRackTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var STS\CMDB\CMDBRack
     */
    protected $object;

    /**
     * @var STS\CMDB\CMDBRackTable
     */
    ...
    {
        $this->object = new \STS\CMDB\CMDBRack();
        $this->objectTable = new StubCMDBRackTable();
    }
    ...
    /**
     * @covers \STS\CMDB\CMDBRack::getChanges
     * @covers \STS\CMDB\CMDBRack::clearChanges
     */
    ...
    /**
     * @covers \STS\CMDB\CMDBRack::__toString
     */
    ...
    /**
     * @covers \STS\CMDB\CMDBRack::toObject
     */
