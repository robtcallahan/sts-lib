...
{
    /**
     * @var STS\CMDB\CMDBSyncUpdate
     */
    protected $object;

    /**
     * @var STS\CMDB\CMDBSyncUpdateTable
     */
    ...
    {
        $this->object = new \STS\CMDB\CMDBSyncUpdate();
        $this->objectTable = new StubCMDBSyncUpdateTable();
    }
    ...
    /**
     * @covers \STS\CMDB\CMDBSyncUpdate::getChanges
     * @covers \STS\CMDB\CMDBSyncUpdate::clearChanges
     */
    ...
    /**
     * @covers \STS\CMDB\CMDBSyncUpdate::__toString
     */
    ...
    /**
     * @covers \STS\CMDB\CMDBSyncUpdate::toObject
     */
