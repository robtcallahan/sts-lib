...
/*******************************************************************************
 *
 * $Id: CMDBStorageDeviceTest.php 79018 2013-09-19 00:06:03Z rcallaha $
 * $Date: 2013-09-18 20:06:03 -0400 (Wed, 18 Sep 2013) $
 * $Author: rcallaha $
 * $Revision: 79018 $
 * $HeadURL: https://svn.ultradns.net/svn/sts_tools/sts-lib/trunk/test/CMDB/CMDBStorageDeviceTest.php $
 *
 *******************************************************************************
 */

class CMDBStorageDeviceTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var STS\CMDB\CMDBStorageDevice
     */
    protected $object;

    /**
     * @var STS\CMDB\CMDBStorageDeviceTable
     */
    ...
    {
        $this->object = new \STS\CMDB\CMDBStorageDevice();
        $this->objectTable = new StubCMDBStorageDeviceTable();
    }
    ...
    /**
     * @covers \STS\CMDB\CMDBStorageDevice::getChanges
     * @covers \STS\CMDB\CMDBStorageDevice::clearChanges
     */
    ...
    /**
     * @covers \STS\CMDB\CMDBStorageDevice::__toString
     */
    ...
    /**
     * @covers \STS\CMDB\CMDBStorageDevice::toObject
     */
