...
/*******************************************************************************
 *
 * $Id: CMDBNetworkDeviceTest.php 79018 2013-09-19 00:06:03Z rcallaha $
 * $Date: 2013-09-18 20:06:03 -0400 (Wed, 18 Sep 2013) $
 * $Author: rcallaha $
 * $Revision: 79018 $
 * $HeadURL: https://svn.ultradns.net/svn/sts_tools/sts-lib/trunk/test/CMDB/CMDBNetworkDeviceTest.php $
 *
 *******************************************************************************
 */

class CMDBNetworkDeviceTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var STS\CMDB\CMDBNetworkDevice
     */
    protected $object;

    /**
     * @var STS\CMDB\CMDBNetworkDeviceTable
     */
    ...
    {
        $this->object = new \STS\CMDB\CMDBNetworkDevice();
        $this->objectTable = new StubCMDBNetworkDeviceTable();
    }
    ...
    /**
     * @covers \STS\CMDB\CMDBNetworkDevice::getChanges
     * @covers \STS\CMDB\CMDBNetworkDevice::clearChanges
     */
    ...
    /**
     * @covers \STS\CMDB\CMDBNetworkDevice::__toString
     */
    ...
    /**
     * @covers \STS\CMDB\CMDBNetworkDevice::toObject
     */
