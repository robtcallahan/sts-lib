...
/*******************************************************************************
 *
 * $Id: CMDBLocationTest.php 79018 2013-09-19 00:06:03Z rcallaha $
 * $Date: 2013-09-18 20:06:03 -0400 (Wed, 18 Sep 2013) $
 * $Author: rcallaha $
 * $Revision: 79018 $
 * $HeadURL: https://svn.ultradns.net/svn/sts_tools/sts-lib/trunk/test/CMDB/CMDBLocationTest.php $
 *
 *******************************************************************************
 */

class CMDBLocationTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var STS\CMDB\CMDBLocation
     */
    protected $object;

    /**
     * @var STS\CMDB\CMDBLocationTable
     */
    ...
    {
        $this->object = new \STS\CMDB\CMDBLocation();
        $this->objectTable = new StubCMDBLocationTable();
    }
    ...
    /**
     * @covers \STS\CMDB\CMDBLocation::getChanges
     * @covers \STS\CMDB\CMDBLocation::clearChanges
     */
    ...
    /**
     * @covers \STS\CMDB\CMDBLocation::__toString
     */
    ...
    /**
     * @covers \STS\CMDB\CMDBLocation::toObject
     */
