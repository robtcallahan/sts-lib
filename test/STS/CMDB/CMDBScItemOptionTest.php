...
class CMDBScItemOptionTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var STS\CMDB\CMDBScItemOption
     */
    protected $object;

    /**
     * @var STS\CMDB\CMDBScItemOptionTable
     */
    ...
    {
        $this->object = new \STS\CMDB\CMDBScItemOption();
        $this->objectTable = new StubCMDBScItemOptionTable();
    }
    ...
    /**
     * @covers \STS\CMDB\CMDBScItemOption::getChanges
     * @covers \STS\CMDB\CMDBScItemOption::clearChanges
     */
    ...
    /**
     * @covers \STS\CMDB\CMDBScItemOption::__toString
     */
    ...
    /**
     * @covers \STS\CMDB\CMDBScItemOption::toObject
     */
