...
/*******************************************************************************
 *
 * $Id: CMDBSysJournalFieldListTest.php 79018 2013-09-19 00:06:03Z rcallaha $
 * $Date: 2013-09-18 20:06:03 -0400 (Wed, 18 Sep 2013) $
 * $Author: rcallaha $
 * $Revision: 79018 $
 * $HeadURL: https://svn.ultradns.net/svn/sts_tools/sts-lib/trunk/test/CMDB/CMDBSysJournalFieldListTest.php $
 *
 *******************************************************************************
 */

class CMDBSysJournalFieldListTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var STS\CMDB\CMDBSysJournalFieldList
     */
    protected $object;

    /**
     * @var STS\CMDB\CMDBSysJournalFieldListTable
     */
    ...
    {
        $this->object = new \STS\CMDB\CMDBSysJournalFieldList();
        $this->objectTable = new StubCMDBSysJournalFieldListTable();
    }
    ...
    /**
     * @covers \STS\CMDB\CMDBSysJournalFieldList::getChanges
     * @covers \STS\CMDB\CMDBSysJournalFieldList::clearChanges
     */
    ...
    /**
     * @covers \STS\CMDB\CMDBSysJournalFieldList::__toString
     */
    ...
    /**
     * @covers \STS\CMDB\CMDBSysJournalFieldList::toObject
     */
