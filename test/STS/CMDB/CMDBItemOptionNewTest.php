...
/*******************************************************************************
 *
 * $Id: CMDBItemOptionNewTest.php 79018 2013-09-19 00:06:03Z rcallaha $
 * $Date: 2013-09-18 20:06:03 -0400 (Wed, 18 Sep 2013) $
 * $Author: rcallaha $
 * $Revision: 79018 $
 * $HeadURL: https://svn.ultradns.net/svn/sts_tools/sts-lib/trunk/test/CMDB/CMDBItemOptionNewTest.php $
 *
 *******************************************************************************
 */

class CMDBItemOptionNewTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var STS\CMDB\CMDBItemOptionNew
     */
    protected $object;

    /**
     * @var STS\CMDB\CMDBItemOptionNewTable
     */
    ...
    {
        $this->object = new \STS\CMDB\CMDBItemOptionNew();
        $this->objectTable = new StubCMDBItemOptionNewTable();
    }
    ...
    /**
     * @covers \STS\CMDB\CMDBItemOptionNew::getChanges
     * @covers \STS\CMDB\CMDBItemOptionNew::clearChanges
     */
    ...
    /**
     * @covers \STS\CMDB\CMDBItemOptionNew::__toString
     */
    ...
    /**
     * @covers \STS\CMDB\CMDBItemOptionNew::toObject
     */
