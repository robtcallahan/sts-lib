...
class CMDBListTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var STS\CMDB\CMDBList
     */
    protected $object;

    /**
     * @var STS\CMDB\CMDBListTable
     */
    ...
    {
        $this->object = new \STS\CMDB\CMDBList();
        $this->objectTable = new StubCMDBListTable("status", "cmdb_ci_server");
    }
    ...
    /**
     * @covers \STS\CMDB\CMDBList::getChanges
     * @covers \STS\CMDB\CMDBList::clearChanges
     */
    ...
    /**
     * @covers \STS\CMDB\CMDBList::__toString
     */
    ...
    /**
     * @covers \STS\CMDB\CMDBList::toObject
     */
