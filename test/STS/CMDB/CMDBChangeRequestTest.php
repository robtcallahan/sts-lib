...
class CMDBChangeRequestTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var STS\CMDB\CMDBChangeRequest
     */
    protected $object;

    /**
     * @var STS\CMDB\CMDBChangeRequestTable
     */
    ...
    {
        $this->object = new \STS\CMDB\CMDBChangeRequest();
        $this->objectTable = new StubCMDBChangeRequestTable();
    }
    ...
    /**
     * @covers \STS\CMDB\CMDBChangeRequest::getChanges
     * @covers \STS\CMDB\CMDBChangeRequest::clearChanges
     */
    ...
    /**
     * @covers \STS\CMDB\CMDBChangeRequest::__toString
     */
    ...
    /**
     * @covers \STS\CMDB\CMDBChangeRequest::toObject
     */
