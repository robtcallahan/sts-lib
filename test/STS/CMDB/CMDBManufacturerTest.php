...
/*******************************************************************************
 *
 * $Id: CMDBManufacturerTest.php 79018 2013-09-19 00:06:03Z rcallaha $
 * $Date: 2013-09-18 20:06:03 -0400 (Wed, 18 Sep 2013) $
 * $Author: rcallaha $
 * $Revision: 79018 $
 * $HeadURL: https://svn.ultradns.net/svn/sts_tools/sts-lib/trunk/test/CMDB/CMDBManufacturerTest.php $
 *
 *******************************************************************************
 */

class CMDBManufacturerTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var STS\CMDB\CMDBManufacturer
     */
    protected $object;

    /**
     * @var STS\CMDB\CMDBManufacturerTable
     */
    ...
    {
        $this->object = new \STS\CMDB\CMDBManufacturer();
        $this->objectTable = new StubCMDBManufacturerTable();
    }
    ...
    /**
     * @covers \STS\CMDB\CMDBManufacturer::getChanges
     * @covers \STS\CMDB\CMDBManufacturer::clearChanges
     */
    ...
    /**
     * @covers \STS\CMDB\CMDBManufacturer::__toString
     */
    ...
    /**
     * @covers \STS\CMDB\CMDBManufacturer::toObject
     */
