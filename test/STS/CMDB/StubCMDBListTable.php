...
class StubCMDBListTable extends \STS\CMDB\CMDBListTable
{
    public function __construct($listName, $tableName, $useUserCredentials = false)
    {
        parent::__construct($listName, $tableName, $useUserCredentials);
    }
