...
/*******************************************************************************
 *
 * $Id: CMDBGroupTest.php 79018 2013-09-19 00:06:03Z rcallaha $
 * $Date: 2013-09-18 20:06:03 -0400 (Wed, 18 Sep 2013) $
 * $Author: rcallaha $
 * $Revision: 79018 $
 * $HeadURL: https://svn.ultradns.net/svn/sts_tools/sts-lib/trunk/test/CMDB/CMDBGroupTest.php $
 *
 *******************************************************************************
 */

class CMDBGroupTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var STS\CMDB\CMDBGroup
     */
    protected $object;

    /**
     * @var STS\CMDB\CMDBGroupTable
     */
    ...
    {
        $this->object = new \STS\CMDB\CMDBGroup();
        $this->objectTable = new StubCMDBGroupTable();
    }
    ...
    /**
     * @covers \STS\CMDB\CMDBGroup::getChanges
     * @covers \STS\CMDB\CMDBGroup::clearChanges
     */
    ...
    /**
     * @covers \STS\CMDB\CMDBGroup::__toString
     */
    ...
    /**
     * @covers \STS\CMDB\CMDBGroup::toObject
     */
