...
class CMDBRelationshipTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var STS\CMDB\CMDBRelationship
     */
    protected $object;

    /**
     * @var STS\CMDB\CMDBRelationshipTable
     */
     ...
     * @var string
     */
    protected $propToTest = "sysClassName";
    ...
    {
        $this->object = new \STS\CMDB\CMDBRelationship();
        $this->objectTable = new StubCMDBRelationshipTable();
    }
    ...
    /**
     * @covers \STS\CMDB\CMDBRelationship::getChanges
     * @covers \STS\CMDB\CMDBRelationship::clearChanges
     */
    ...
    /**
     * @covers \STS\CMDB\CMDBRelationship::__toString
     */
    ...
    /**
     * @covers \STS\CMDB\CMDBRelationship::toObject
     */
