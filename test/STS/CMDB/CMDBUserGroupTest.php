...
/*******************************************************************************
 *
 * $Id: CMDBUserGroupTest.php 79018 2013-09-19 00:06:03Z rcallaha $
 * $Date: 2013-09-18 20:06:03 -0400 (Wed, 18 Sep 2013) $
 * $Author: rcallaha $
 * $Revision: 79018 $
 * $HeadURL: https://svn.ultradns.net/svn/sts_tools/sts-lib/trunk/test/CMDB/CMDBUserGroupTest.php $
 *
 *******************************************************************************
 */

class CMDBUserGroupTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var STS\CMDB\CMDBUserGroup
     */
    protected $object;

    /**
     * @var STS\CMDB\CMDBUserGroupTable
     */
    ...
    {
        $this->object = new \STS\CMDB\CMDBUserGroup();
        $this->objectTable = new StubCMDBUserGroupTable();
    }
    ...
    /**
     * @covers \STS\CMDB\CMDBUserGroup::getChanges
     * @covers \STS\CMDB\CMDBUserGroup::clearChanges
     */
    ...
    /**
     * @covers \STS\CMDB\CMDBUserGroup::__toString
     */
    ...
    /**
     * @covers \STS\CMDB\CMDBUserGroup::toObject
     */
