...
class CMDBRequestTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var STS\CMDB\CMDBRequest
     */
    protected $object;

    /**
     * @var STS\CMDB\CMDBRequestTable
     */
    ...
    {
        $this->object = new \STS\CMDB\CMDBRequest();
        $this->objectTable = new StubCMDBRequestTable();
    }
    ...
    /**
     * @covers \STS\CMDB\CMDBRequest::getChanges
     * @covers \STS\CMDB\CMDBRequest::clearChanges
     */
    ...
    /**
     * @covers \STS\CMDB\CMDBRequest::__toString
     */
    ...
    /**
     * @covers \STS\CMDB\CMDBRequest::toObject
     */
