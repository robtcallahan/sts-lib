...
/*******************************************************************************
 *
 * $Id: CMDBBusinessServiceTest.php 79018 2013-09-19 00:06:03Z rcallaha $
 * $Date: 2013-09-18 20:06:03 -0400 (Wed, 18 Sep 2013) $
 * $Author: rcallaha $
 * $Revision: 79018 $
 * $HeadURL: https://svn.ultradns.net/svn/sts_tools/sts-lib/trunk/test/CMDB/CMDBBusinessServiceTest.php $
 *
 *******************************************************************************
 */

class CMDBBusinessServiceTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var STS\CMDB\CMDBBusinessService
     */
    protected $object;
    ...
    {
        $this->object = new \STS\CMDB\CMDBBusinessService();
    ...
    /**
     * @covers \STS\CMDB\CMDBBusinessService::getChanges
     * @covers \STS\CMDB\CMDBBusinessService::clearChanges
     */
    ...
    /**
     * @covers \STS\CMDB\CMDBBusinessService::__toString
     */
    ...
    /**
     * @covers \STS\CMDB\CMDBBusinessService::toObject
     */
