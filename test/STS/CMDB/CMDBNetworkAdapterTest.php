...
/*******************************************************************************
 *
 * $Id: CMDBNetworkAdapterTest.php 79018 2013-09-19 00:06:03Z rcallaha $
 * $Date: 2013-09-18 20:06:03 -0400 (Wed, 18 Sep 2013) $
 * $Author: rcallaha $
 * $Revision: 79018 $
 * $HeadURL: https://svn.ultradns.net/svn/sts_tools/sts-lib/trunk/test/CMDB/CMDBNetworkAdapterTest.php $
 *
 *******************************************************************************
 */

class CMDBNetworkAdapterTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var STS\CMDB\CMDBNetworkAdapter
     */
    protected $object;

    /**
     * @var STS\CMDB\CMDBNetworkAdapterTable
     */
    ...
    {
        $this->object = new \STS\CMDB\CMDBNetworkAdapter();
        $this->objectTable = new StubCMDBNetworkAdapterTable();
    }
    ...
    /**
     * @covers \STS\CMDB\CMDBNetworkAdapter::getChanges
     * @covers \STS\CMDB\CMDBNetworkAdapter::clearChanges
     */
    ...
    /**
     * @covers \STS\CMDB\CMDBNetworkAdapter::__toString
     */
    ...
    /**
     * @covers \STS\CMDB\CMDBNetworkAdapter::toObject
     */
