...
class CMDBTaskTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var STS\CMDB\CMDBTask
     */
    protected $object;

    /**
     * @var STS\CMDB\CMDBTaskTable
     */
    ...
    {
        $this->object = new \STS\CMDB\CMDBTask();
        $this->objectTable = new StubCMDBTaskTable();
    }
    ...
    /**
     * @covers \STS\CMDB\CMDBTask::getChanges
     * @covers \STS\CMDB\CMDBTask::clearChanges
     */
    ...
    /**
     * @covers \STS\CMDB\CMDBTask::__toString
     */
    ...
    /**
     * @covers \STS\CMDB\CMDBTask::toObject
     */
