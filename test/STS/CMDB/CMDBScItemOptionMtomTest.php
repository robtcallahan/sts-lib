...
class CMDBScItemOptionMtomTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var STS\CMDB\CMDBScItemOptionMtom
     */
    protected $object;

    /**
     * @var STS\CMDB\CMDBScItemOptionMtomTable
     */
     ...
     * @var string
     */
    protected $propToTest = "requestItem";
    ...
    {
        $this->object = new \STS\CMDB\CMDBScItemOptionMtom();
        $this->objectTable = new StubCMDBScItemOptionMtomTable();
    }
    ...
    /**
     * @covers \STS\CMDB\CMDBScItemOptionMtom::getChanges
     * @covers \STS\CMDB\CMDBScItemOptionMtom::clearChanges
     */
    ...
    /**
     * @covers \STS\CMDB\CMDBScItemOptionMtom::__toString
     */
    ...
    /**
     * @covers \STS\CMDB\CMDBScItemOptionMtom::toObject
     */
