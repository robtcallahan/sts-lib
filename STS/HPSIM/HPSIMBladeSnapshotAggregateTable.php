...
class HPSIMBladeSnapshotAggregateTable extends DBTable
{
    protected $dbIndex = 'hpsim';
   	protected $tableName = 'blade_snapshot_aggregate';
    ...
    /**
   	 * @param $date
   	 * @return HPSIMBladeSnapshotAggregate[]
   	 */
    ...
    /**
     * @param HPSIMBladeSnapshotAggregate $o
     * @param string $sql
     * @return HPSIMBladeSnapshotAggregate
     */
    ...
    private function _set($dbRowObj = null)
	{
		...
		$o = new HPSIMBladeSnapshotAggregate();
		if ($dbRowObj) {
