...
/*******************************************************************************
 *
 * $Id: SANScreenPortTable.php 82460 2014-01-04 15:38:17Z rcallaha $
 * $Date: 2014-01-04 10:38:17 -0500 (Sat, 04 Jan 2014) $
 * $Author: rcallaha $
 * $Revision: 82460 $
 * $HeadURL: https://svn.ultradns.net/svn/sts_tools/sts-lib/trunk/STS/SANScreen/SANScreenPortTable.php $
 *
 *******************************************************************************
 */
...
class SANScreenPortTable extends DBTable
{
    protected $dbIndex = 'sanscreen';
   	protected $tableName = 'port';
    protected $idAutoIncremented = false;

	protected static $columnNames = array(
		"id", "name", "connectedPortId", "deviceId", "nodeId", "speed",
		"state", "status", "wwn", "dead"
	);
