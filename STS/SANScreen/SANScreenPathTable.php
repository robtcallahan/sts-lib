...
/*******************************************************************************
 *
 * $Id: SANScreenPathTable.php 82460 2014-01-04 15:38:17Z rcallaha $
 * $Date: 2014-01-04 10:38:17 -0500 (Sat, 04 Jan 2014) $
 * $Author: rcallaha $
 * $Revision: 82460 $
 * $HeadURL: https://svn.ultradns.net/svn/sts_tools/sts-lib/trunk/STS/SANScreen/SANScreenPathTable.php $
 *
 *******************************************************************************
 */
...
class SANScreenPathTable extends DBTable
{
	...
	protected static $columnNames = array(
		"id", "arrayId", "hostId", "volumeId", "minimumNumberOfHops", "numberOfFabrics",
		"numberOfHostPorts", "numberOfStoragePorts", "spf", "startTime", "endTime"
	);
