...
/*******************************************************************************
 *
 * $Id: CMDBTask.php 79018 2013-09-19 00:06:03Z rcallaha $
...
class CMDBTask
{
	...
	protected $assignmentGroup; // text   (Security Operations)
	...
	{
		$return = "";
		foreach (CMDBTaskTable::getNameMapping() as $prop) {
    ...
    /**
     * @param mixed $requestNumberId
     */
    public function setRequestNumberId($requestNumberId)
    {
        $this->updateChanges(func_get_arg(0));
     ...
     * @return mixed
     */
    public function getRequestNumberId()
    {
        return $this->requestNumberId;
    }
